	      ...
	      <p><table align="center" class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">
                    ...
                    <asp:DropDownList ID="ddlContent" runat="server" DataSourceID="SqlDataSource1" DataTextField="contents_name" DataValueField="contents_name">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStr %>" SelectCommand="SELECT [contents_name] FROM [Contents]"></asp:SqlDataSource>
                </td>
               ...
               <tr>
                <td class="auto-style3">
                    ...
                    <asp:DropDownList ID="ddlLang" runat="server" DataSourceID="SqlDataSource2" DataTextField="language_type" DataValueField="language_type">
                        <asp:ListItem>JAVA</asp:ListItem>
                        <asp:ListItem>C#</asp:ListItem>
                        <asp:ListItem>VB</asp:ListItem>
                        <asp:ListItem>Python</asp:ListItem>
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStr %>" SelectCommand="SELECT [language_type] FROM [Languages]"></asp:SqlDataSource>
                </td>
                <td class="auto-style3">
                    </td>
            </tr>
            <tr>
                <td class="auto-style11">
                    <font size="3">Source Code :&nbsp;</font> <asp:TextBox ID="txtSC" runat="server" Height="276px" TextMode="MultiLine" Width="409px">
</asp:TextBox>
                </td>
