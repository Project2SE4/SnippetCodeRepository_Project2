    ...
    public partial class Phyton : System.Web.UI.Page
    {
        ...
        private void PopulateData()
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                string sql = " Select * From Python ORDER BY PythonId DESC ";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                string sql = "Update Python set Content_python = @ContentP, Sourcecode_python = @SourcecodeP  " + " where PythonId = @PID";
                ...
                using (SqlCommand cmd = new SqlCommand(sql, conn))
                {
                    ...
                    "@PID", Convert.ToInt32(lblID.Text));
