         ...
         using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(sql, conn))
                {
                    ...
                    //ScriptManager.RegisterStartupScript(this, typeof(Page), "myscript", "setTimeout(function(){location.href='CSharp.aspx';},3500);", true);

                    ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "alertMessage", @"alert('Record Inserted Successfully'); window.location = '" + Page.ResolveUrl("~/CSharp.aspx") + "';", true);
