    ...
    public partial class Phyton : System.Web.UI.Page
    {
        ...
        protected void DeleteRow(object sender, GridViewDeleteEventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                string sql = "Delete from PhytonId" +
        ...
        protected void UpdateRow(object sendedr, GridViewUpdateEventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                string sql = "Update Phyton set Content_phyton = @ContentP " + " where PhytonId = @PID";
        ...
        protected void imgbtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            lblCode.Text = gvrow.Cells[3].Text;
