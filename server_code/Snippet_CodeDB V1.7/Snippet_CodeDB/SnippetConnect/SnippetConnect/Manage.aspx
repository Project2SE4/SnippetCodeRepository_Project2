	  ...
	  <div id="content">
        <div class="content_item">
		  ...
		  <br style="clear:both"/>
            ...
            <br />
            <asp:Button ID="btnPhyton" runat="server" BorderColor="Black" EnableTheming="True" Height="50px" PostBackUrl="~/Phyton.aspx" style="font-size: medium; font-weight: 700; border-width: 4px" Text="Phyton" Width="102px" />
