<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Phyton.aspx.cs" Inherits="SnippetConnect.Phyton" %>
...
<body>
  ...
  <div id="main">
    ...
    OnRowUpdating="UpdateRow" DataKeyNames="PhytonId" OnRowDeleting="DeleteRow" AllowPaging="True" OnPageIndexChanging="ChangePage" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
    ...
    <Columns>
        ...
        <asp:BoundField HeaderText="ID" DataField="PhytonId" ReadOnly="true"/>

        <asp:BoundField HeaderText="Content" DataField="Content_phyton" ReadOnly="true" />

        <asp:BoundField DataField="Sourcecode_phyton" HeaderText="Source Code" ReadOnly="True"/>
