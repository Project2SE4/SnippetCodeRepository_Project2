...
<body>
  ...
  <div id="main">
    ...
    DataKeyNames="CSharpId" OnRowDeleting="DeleteRow" AllowPaging="True" OnPageIndexChanging="ChangePage" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 

    GridLines="Vertical" style="font-size: medium; text-align: center;" PageSize="20" >
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Sourcecode_c" ReadOnly="True" HeaderText="Source Code" >
