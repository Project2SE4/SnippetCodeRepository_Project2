...
<body>
  ...
  <div id="main">
    ...
    OnRowUpdating="UpdateRow" DataKeyNames="contents_id" OnRowDeleting="DeleteRow" AllowPaging="True"

    PageSize="10" OnPageIndexChanging="ChangePage" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 

    GridLines="Vertical" style="font-size: large" OnRowDataBound="gvData_RowDataBound" >
...
<asp:BoundField HeaderText="ID" DataField="contents_id" ReadOnly="true" />

<asp:TemplateField HeaderText="Content">

<ItemTemplate>

<%# Eval("contents_name") %></ItemTemplate>

<EditItemTemplate>

<asp:TextBox ID="txtCont" runat="server" Text='<%# Eval("contents_name") %>'/>
...
<%# Eval("language_type") %></ItemTemplate>

<EditItemTemplate>

<asp:TextBox ID="txtLang" runat="server" Text='<%# Eval("language_type") %>'/>
...
<ItemTemplate>
<asp:HyperLink Text="View" runat="server" id="hyplnk1" Font-Underline="true" style=" cursor:move;"> 
 </asp:HyperLink>
</ItemTemplate>
</asp:TemplateField>
...
<%--<asp:TemplateField HeaderText="Source Code">
<ItemTemplate> 
<asp:HyperLink ID="HyperLink1" Text="View" NavigateUrl=<%# Eval("code", "javascript:window.open('popupcode.aspx?code={0}','popWindow','height=800,resiz‌​able=yes,width=1000')")%> runat="server">
</asp:HyperLink> 
</ItemTemplate> 
</asp:TemplateField>--%>
...
<asp:TextBox ID="txtSC" runat="server" Text='<%# Eval("code") %>' Columns="3" />
