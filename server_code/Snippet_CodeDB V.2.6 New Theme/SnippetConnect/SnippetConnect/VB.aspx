...
<body>
  ...
  <div id="main">
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1><strong>Data VB Management</strong></h1> 
	      <p>
    ...
    <Columns>
        ...
        <asp:BoundField  HeaderText="Code" DataField="Sourcecode_vb" ReadOnly="True">
        ...
        <asp:BoundField HeaderText="Date Add" DataField="DateAdd_vb" ReadOnly="true" />
