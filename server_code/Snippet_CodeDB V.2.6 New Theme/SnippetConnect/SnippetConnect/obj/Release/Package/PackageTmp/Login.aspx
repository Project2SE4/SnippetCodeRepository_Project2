  ...
  <div id="main">
	...
	<div id="site_content">		
	  ...
	  <div id="content">
		...
		<br><br><br><h1><strong>Login Admin</strong> </h1>
	        <table class="auto-style2">
                ...
                <tr>
                    ...
                    <td class="auto-style5">
                        <asp:CheckBox ID="cbRem" runat="server" Text=" Remember Me" style="text-align: left" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">
                        <asp:HyperLink ID="hylForgot" runat="server" Font-Underline="True" ForeColor="Blue" NavigateUrl="~/PasswordRecovery.aspx">ForgotPassword</asp:HyperLink>
                    </td>
                    <td class="auto-style5">
                        &nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:Button ID="btnLogin" runat="server" Height="35px" style="font-weight: 700; color: #000066;" Text="Login" Width="71px" OnClick="btnLogin_Click" />
                    </td>
                </tr>
            </table>
		  <br style="clear:both"/>
