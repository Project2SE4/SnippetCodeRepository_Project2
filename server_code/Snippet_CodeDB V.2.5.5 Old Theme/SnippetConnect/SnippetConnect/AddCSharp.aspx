<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCSharp.aspx.cs" Inherits="SnippetConnect.Add" %>
	      ...
	      <p><table align="center" class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">
                    <font size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>Language :&nbsp;</strong>&nbsp;</font> C#</td>
            ...
            <asp:Label ID="lblMessage" runat="server" ForeColor="Green" EnableViewState="false" style="font-size: large" />
                </td>
