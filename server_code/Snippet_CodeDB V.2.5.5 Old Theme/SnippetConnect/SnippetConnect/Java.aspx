...
<body>
  ...
  <div id="main">
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1><strong>Data Java Management</strong></h1> 
	      <p>
    ...
    DataKeyNames="JavaId" OnRowDeleting="DeleteRow" AllowPaging="True" OnPageIndexChanging="ChangePage" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
    ...
    <Columns>
        ...
        <asp:BoundField HeaderText="ID" DataField="JavaId" ReadOnly="true"/>

        <asp:BoundField HeaderText="Content" DataField="Content_java" ReadOnly="true" />

        <asp:BoundField  HeaderText="Code" DataField="Sourcecode_java" ReadOnly="True">
        ...
        <asp:BoundField HeaderText="Date Add" DataField="DateAdd_java" ReadOnly="true" />
