<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Python.aspx.cs" Inherits="SnippetConnect.Phyton" %>
...
<body>
  ...
  <div id="main">
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1><strong>Data Python Management</strong></h1> 
	      <p>
              <asp:Button ID="btnAdd" runat="server" Text="Add" Height="33px" style="font-weight: 700" Width="80px" PostBackUrl="~/AddPython.aspx" />
            </p>
    ...
    DataKeyNames="PythonId" OnRowDeleting="DeleteRow" AllowPaging="True" OnPageIndexChanging="ChangePage" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
    ...
    <Columns>
        ...
        <asp:BoundField HeaderText="ID" DataField="PythonId" ReadOnly="true"/>

        <asp:BoundField HeaderText="Content" DataField="Content_python" ReadOnly="true" />

        <asp:BoundField DataField="Sourcecode_python" HeaderText="Code" ReadOnly="True">
        ...
        <asp:BoundField HeaderText="Date Add" DataField="DateAdd_python" ReadOnly="true" />
