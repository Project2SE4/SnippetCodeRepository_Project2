    ...
    public partial class Java : System.Web.UI.Page
    {
        ...
        private void PopulateData()
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connStr))
            {
                ...
                string sql = " Select * From JavaCode ORDER BY JavaId DESC";
        ...
        protected void imgbtnedit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            txtContent.Text = gvrow.Cells[2].Text.Replace("&quot;", "\"").Replace("&#39;", "'").Replace("&amp;", "&").Replace("&lt;", "<").Replace("&gt;", ">").Replace("&nbsp;", " ").Replace("&#160;", " ").Replace("&euro;", "€");
            txtSC.Text = gvrow.Cells[3].Text.Replace("&quot;", "\"").Replace("&#39;", "'").Replace("&amp;", "&").Replace("&lt;", "<").Replace("&gt;", ">").Replace("&nbsp;", " ").Replace("&#160;", " ").Replace("&euro;", "€");
        ...
        protected void imgbtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //lblID.Text = gvData.DataKeys[gvrow.RowIndex].Value.ToString();
            txtCode.Text = gvrow.Cells[3].Text.Replace("&quot;", "\"").Replace("&#39;", "'").Replace("&amp;", "&").Replace("&lt;", "<").Replace("&gt;", ">").Replace("&nbsp;", " ").Replace("&#160;", " ").Replace("&euro;", "€");
