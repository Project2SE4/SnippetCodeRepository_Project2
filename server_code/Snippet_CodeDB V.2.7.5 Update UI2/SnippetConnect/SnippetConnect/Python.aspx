...
<div id="tooplate_data">
	<div class="col_3">
    	<div class="title_with_icon">
            <strong><span class="auto-style4">Data Python Management<br />
            </span></strong><br />
    ...
    <div class="lang">
        ...
        <asp:GridView ID="gvData" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
                      BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="PythonId" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="ChangePage" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PythonId" HeaderText="ID" ReadOnly="true" />
                <asp:BoundField DataField="Content_python" HeaderText="Content" ReadOnly="true" />
                ...
                <asp:BoundField DataField="DateAdd_python" HeaderText="Date Add" ReadOnly="true" />
