...
<div id="tooplate_data">
	<div class="col_3">
    	<div class="title_with_icon">
            <strong><span class="auto-style4">Data CSharp Management<br />
            </span></strong><br />
    ...
    <div class="lang">
        ...
        <asp:GridView ID="gvData" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="CSharpId" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="ChangePage" OnRowCancelingEdit="CancelEditRow" OnRowDeleting="DeleteRow" OnRowEditing="EditRow" PageSize="20" style="font-size: medium; text-align: center;" Width="100%">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CSharpId" HeaderText="ID" ReadOnly="true" />
                <asp:BoundField DataField="Content_c" HeaderText="Content" ReadOnly="true" />
        ...
        <EditItemTemplate>
            ...
            <asp:TextBox ID="txtSC" runat="server" Text='<%# Eval("Sourcecode_c") %>' TextMode="MultiLine" Width="400px" Height="400px"/>
                ...
                <asp:BoundField DataField="Sourcecode_c" HeaderText="Code" ReadOnly="True">
                ...
                <asp:BoundField DataField="DateAdd_c" HeaderText="Date Add" ReadOnly="true" />
        ...
        <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" BackgroundCssClass="modalBackground" CancelControlID="btnCancel1" PopupControlID="pnlpopup" TargetControlID="btnShowPopup">
