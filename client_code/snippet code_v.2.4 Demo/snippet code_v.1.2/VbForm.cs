...
{
    public partial class VbForm : Form
    {
        ...
        public void FindVb()
        {
            string xmlFile = Application.StartupPath + "\\data\\VB.xml";

            DataSet ds = new DataSet();
            ds.ReadXml(xmlFile, XmlReadMode.InferSchema);

            DataTable VBTables = ds.Tables["VB"];
            ...
            DataRow[] filteredRows = VBTables.Select("Sourcecode_vb LIKE '%" + curItem + "%'");
            ...
            for (i = 0; i < filteredRows.Length; i++)
            {
                ...
                string str = (filteredRows[i]["Sourcecode_vb"].ToString());
        ...
        private void searchBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataTable CSharpTables = ds.Tables["vb"];

                string searchstring = textBox1.Text;

                DataRow[] filteredRows = CSharpTables.Select("Content_vb LIKE '%" + searchstring + "%'");
                List<string> nList = new List<string>();
                ...
                try
                {
                    ...
                    for (i = 0; i < filteredRows.Length; i++)
                    {
                        nList.Add(filteredRows[i]["Content_vb"].ToString());
                    }
